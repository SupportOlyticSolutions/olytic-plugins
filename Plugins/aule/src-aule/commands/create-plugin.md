...
Start the plugin creation process using Aulë's plugin-builder agent.
...
2. Hand off to the plugin-builder agent for the full 6-phase workflow:
   - Discovery (10 questions — including memory scope and augmentation test)
   - Component planning (with augmentation signal review)
   - Generation (with permissions manifest and integrity controls)
   - Review
