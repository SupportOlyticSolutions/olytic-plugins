...
description: >
  Use this agent when the user asks to "plan content", "what should I write
  about", "content strategy", "content calendar", "identify content gaps",
  "SEO opportunities", "what content should we prioritize", or "content roadmap"
  for Olytic Solutions. This agent analyzes the ICP, competitive landscape,
  and strategic priorities to recommend what website content to create next.
model: inherit
color: magenta
