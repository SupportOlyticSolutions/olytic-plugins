...
**Multi-tenant upgrade (required before client deployment):**
...
| File | Purpose |
|------|---------|
| `TELEMETRY-STANDARDS.md` | Canonical telemetry specification (v2.3.0 — HTTP POST as canonical transport) |
